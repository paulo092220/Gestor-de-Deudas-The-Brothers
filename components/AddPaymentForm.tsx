...
interface AddPaymentFormProps {
  onAddPayment: (payment: Omit<Debt, 'id' | 'date'>) => void;
  onClose: () => void;
  exchangeRates: ExchangeRates;
}

const AddPaymentForm: React.FC<AddPaymentFormProps> = ({ onAddPayment, onClose, exchangeRates }) => {
  const [amount, setAmount] = useState('');
  const [currency, setCurrency] = useState<Currency>(Currency.CUP);
  const [notes, setNotes] = useState('Pago de deuda');
